...
%     p   = [l_OA l_OB l_AC l_DE]';
    ...
    function my_callback(new_data)
        ...
        h11.XData(end+1:end+N) = t;   
        h11.YData(end+1:end+N) = -pos1; % switch sign on all plotted values due to direction motors are mounted
        h12.XData(end+1:end+N) = t;   
        h12.YData(end+1:end+N) = -vel1;
        h13.XData(end+1:end+N) = t;   
        h13.YData(end+1:end+N) = -cur1;
        h14.XData(end+1:end+N) = t;   
        h14.YData(end+1:end+N) = -dcur1;
        h15.XData(end+1:end+N) = t;   
        h15.YData(end+1:end+N) = -duty1;
        h16.XData(end+1:end+N) = t;
        h16.YData(end+1:end+N) = -pos1_des;
        h17.XData(end+1:end+N) = t;
        h17.YData(end+1:end+N) = -vel1_des;
