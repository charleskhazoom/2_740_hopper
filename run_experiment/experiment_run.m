...
data = load('test_traj_right_kt_mu_0_8.mat'); % load in trajectory data
...
hip_flight = 0.8031;    % initial hip
knee_flight = -2.2943;  % initial knee
arm_flight = -0.5236;   % inital arm
...
angle1_init = 0 - deg2rad(20);            % hip angle % -75 deg
