...
bounds.phase(1).finaltime.lower = 0.18;
...
%% Initial Guess
guess_solution = load('guess_solution_stance_only.mat','solution');
for i = 1:1
...
%% Problem Setup
setup.name = 'jumpOptStanceOnly';
setup.functions.continuous = @jumpOptContinuousStanceOnly;
setup.functions.endpoint = @jumpOptEndpointStanceOnly;
...
setup.nlp.ipoptoptions.maxiterations = 55550;
...
save('guess_solution_stance_only','solution');
...
% plot_solution(tout,zout,uout,tLO,p,2); %outputs next fignb
